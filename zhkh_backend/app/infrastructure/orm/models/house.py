...
class House(BaseModel):
    ...
    sewerage_network_material = Column(String, comment="Материал сети водоотведения")
    ...
    heating_network_material = Column(String, comment="Материал сети отопления")
    heating_insulation_material = Column(
        String, comment="Материал теплоизоляции сети отопления"
    )
    ...
    heating_riser_material = Column(String, comment="Материал стояков отопления")
    ...
    cold_water_network_material = Column(String, comment="Материал сети ХВС")

    # --- Стояки системы холодного водоснабжения ---
    cold_water_riser_wear = Column(Float, comment="Физический износ стояков ХВС")
    cold_water_riser_material = Column(String, comment="Материал стояков ХВС")
