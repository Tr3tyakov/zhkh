...
def upgrade() -> None:
    ...
    op.alter_column('house', 'heating_insulation_material',
                    ...
                    existing_nullable=True)
    op.alter_column('house', 'heating_riser_material',
                    existing_type=sa.VARCHAR(),
                    type_=sa.Integer(),
                    ...
                    existing_nullable=True)
    op.alter_column('house', 'cold_water_network_material',
                    existing_type=sa.VARCHAR(),
                    type_=sa.Integer(),
                    ...
                    existing_nullable=True)
    op.alter_column('house', 'cold_water_riser_material',
                    existing_type=sa.VARCHAR(),
                    type_=sa.Integer(),
                    ...
                    existing_nullable=True)
    op.create_foreign_key("heating_insulation_material", 'house', 'reference_book_value',
                          ['heating_insulation_material'], ['id'])
    op.create_foreign_key("cold_water_network_material", 'house', 'reference_book_value',
                          ['cold_water_network_material'], ['id'])
    op.create_foreign_key("heating_riser_material", 'house', 'reference_book_value', ['heating_riser_material'], ['id'])
    op.create_foreign_key("heating_network_material", 'house', 'reference_book_value', ['heating_network_material'],
                          ['id'])
    op.create_foreign_key("cold_water_riser_material", 'house', 'reference_book_value', ['cold_water_riser_material'],
                          ['id'])
