...
def upgrade() -> None:
    ...
    op.create_table(
        "reference_book",
        sa.Column(
            "name", sa.String(), nullable=False, comment="Наименование справочника"
        ),
        sa.Column(
            "id",
            sa.Integer(),
    ...
    op.create_table(
        "user",
        sa.Column(
            "first_name", sa.String(), nullable=False, comment="Имя пользователя"
        ),
        sa.Column(
            "middle_name", sa.String(), nullable=False, comment="Фамилия пользователя"
        ),
        sa.Column(
            "last_name", sa.String(), nullable=False, comment="Отчество пользователя"
        ),
        sa.Column("email", sa.String(), nullable=False, comment="Почта пользователя"),
        sa.Column(
            "password", sa.String(), nullable=False, comment="Пароль пользователя"
        ),
        sa.Column(
            "last_login_date",
            sa.DateTime(),
        ...
        sa.Column(
            "user_type",
            sa.Enum("USER", "ADMIN", name="usertypeenum"),
            nullable=False,
        ...
        sa.Column(
            ...
            sa.String(),
            nullable=True,
            comment="Ключ файла аватара пользователя в S3 хранилище",
        ),
        sa.Column(
            "account_status",
            sa.Enum("ACTIVE", "BLOCKED", name="useraccountstatusenum"),
            nullable=False,
            comment="Статус аккаунта пользователя",
        ),
        sa.Column(
            "private_phone", sa.String(), nullable=True, comment="Личный телефон"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "entity_type",
            sa.Enum("HOUSE", "COMPANY", "USER", "DATA", name="entitytypeenum"),
            nullable=False,
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Идентификатор объекта действия",
        ),
        ...
        sa.Column(
            "user_agent", sa.Text(), nullable=True, comment="User-Agent пользователя"
        ),
        sa.Column(
            "action_result",
            sa.String(),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=True,
            comment="Форма организации (ООО, АО)",
        ),
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False, comment="Дата создания"),
        sa.Column(
            "updated_at", sa.DateTime(), nullable=False, comment="Дата обновления"
        ),
        sa.Column(
            "id",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Год ввода в эксплуатацию",
        ),
        sa.Column(
            "is_emergency",
            sa.Boolean(),
            nullable=True,
            comment="Признан ли дом аварийным",
        ),
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Количество квартир",
        ),
        sa.Column(
            "non_residential_units_count",
            sa.Integer(),
            nullable=True,
        ...
        sa.Column(
            ...
            sa.Date(),
            nullable=True,
            comment="Дата проведения энергетического обследования",
        ),
        sa.Column(
            "entrances_count",
            sa.Integer(),
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Наибольшее количество этажей",
        ),
        sa.Column(
            "min_floors_count",
            sa.Integer(),
            nullable=True,
            comment="Наименьшее количество этажей",
        ),
        sa.Column(
            "underground_floors_count",
            sa.Integer(),
            nullable=True,
            comment="Количество подземных этажей",
        ),
        sa.Column(
            "capital_repair_fund",
            sa.Integer(),
        ...
        sa.Column(
            "parking_area", sa.Float(), nullable=True, comment="Площадь парковки, м²"
        ),
        sa.Column(
            "has_accessibility",
            sa.Integer(),
        ...
        sa.Column(
            "building_wear_percent",
            sa.Float(),
            nullable=True,
            comment="Износ здания, %",
        ),
        sa.Column(
            "building_wear_date",
            sa.DateTime(),
            nullable=True,
            comment="Дата установления износа",
        ),
        sa.Column(
            "total_area",
            sa.Float(),
            nullable=True,
            comment="Площадь многоквартирного дома, м²",
        ),
        sa.Column(
            "residential_area",
            sa.Float(),
            nullable=True,
            comment="Площадь жилых помещений, м²",
        ),
        sa.Column(
            "non_residential_area",
            sa.Float(),
            nullable=True,
            comment="Площадь нежилых помещений, м²",
        ),
        sa.Column(
            "common_property_area",
            sa.Float(),
            nullable=True,
            comment="Площадь общего имущества, м²",
        ),
        sa.Column(
            "land_area",
            sa.Float(),
            nullable=True,
            comment="Площадь земельного участка, м²",
        ),
        sa.Column(
            "building_series",
            sa.Integer(),
        ...
        sa.Column(
            "sewerage", sa.Integer(), nullable=True, comment="Система водоотведения"
        ),
        sa.Column(
            "drainage_system", sa.Integer(), nullable=True, comment="Система водостоков"
        ),
        sa.Column(
            "gas_supply", sa.Integer(), nullable=True, comment="Система газоснабжения"
        ),
        sa.Column(
            "hot_water_supply",
            sa.Integer(),
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Система пожаротушения",
        ),
        sa.Column(
            "heating", sa.Integer(), nullable=True, comment="Система теплоснабжения"
        ),
        sa.Column(
            "cold_water_supply",
            sa.Integer(),
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Тип мусоропровода",
        ),
        sa.Column(
            "garbage_chute",
            sa.Boolean(),
            nullable=True,
            comment="Наличие мусоропровода",
        ),
        sa.Column(
            "load_bearing_walls",
            sa.Integer(),
            nullable=True,
            comment="Материал несущих стен",
        ),
        sa.Column(
            "basement_area", sa.Float(), nullable=True, comment="Площадь подвала, м²"
        ),
        sa.Column(
            "foundation_type", sa.Integer(), nullable=True, comment="Тип фундамента"
        ),
        sa.Column(
            "foundation_material",
            sa.Integer(),
            nullable=True,
            comment="Материал фундамента",
        ),
        sa.Column(
            "blind_area", sa.Float(), nullable=True, comment="Площадь отмостки, м²"
        ),
        sa.Column(
            "overlap_type", sa.Integer(), nullable=True, comment="Тип перекрытий"
        ),
        sa.Column(
            "hot_water_system_type",
            sa.Integer(),
            nullable=True,
            comment="Тип системы ГВС",
        ),
        sa.Column(
            "hot_water_physical_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ системы ГВС",
        ),
        sa.Column(
            "hot_water_network_material",
            sa.Integer(),
            nullable=True,
            comment="Материал сети ГВС",
        ),
        sa.Column(
            "hot_water_insulation_material",
            sa.Integer(),
            nullable=True,
            comment="Материал теплоизоляции сети ГВС",
        ),
        sa.Column(
            "hot_water_riser_material",
            sa.Integer(),
            nullable=True,
            comment="Материал стояков ГВС",
        ),
        sa.Column(
            "sewerage_system_type",
            sa.Integer(),
            nullable=True,
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Тип внутренних стен",
        ),
        sa.Column(
            "facade_wall_type", sa.Integer(), nullable=True, comment="Тип наружных стен"
        ),
        sa.Column(
        ...
        sa.Column(
            "facade_finishing_material",
            sa.Integer(),
            nullable=True,
            comment="Материал отделки фасада",
        ),
        sa.Column(
            "facade_last_major_repair_year",
            sa.Integer(),
            nullable=True,
            comment="Год последнего капремонта фасада",
        ),
        sa.Column("roof_shape", sa.Integer(), nullable=True, comment="Форма крыши"),
        sa.Column(
            "attic_insulation_layers",
            sa.Integer(),
            nullable=True,
            comment="Утепляющие слои чердачных перекрытий",
        ),
        sa.Column(
            "roof_support_structure_type",
            sa.Integer(),
            nullable=True,
            comment="Вид несущей части крыши",
        ),
        sa.Column(
            "roof_covering_type", sa.Integer(), nullable=True, comment="Тип кровли"
        ),
        sa.Column(
            "roof_last_major_repair_year",
            sa.Integer(),
            nullable=True,
            comment="Год последнего капремонта кровли",
        ),
        sa.Column(
            "window_material", sa.Integer(), nullable=True, comment="Материал окон"
        ),
        sa.Column(
            "heating_physical_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ системы отопления",
        ),
        sa.Column(
        ...
        sa.Column(
            "heating_riser_valve_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ запорной арматуры отопления",
        ),
        sa.Column(
            "heating_device_type",
            sa.Integer(),
        ...
        sa.Column(
            ...
            sa.Float(),
            nullable=True,
            comment="Физический износ отопительных приборов",
        ),
        sa.Column(
            "cold_water_physical_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ системы ХВС",
        ),
        sa.Column(
            "cold_water_network_material",
            sa.String(),
            nullable=True,
            comment="Материал сети ХВС",
        ),
        sa.Column(
            "cold_water_riser_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ стояков ХВС",
        ),
        sa.Column(
            "cold_water_riser_material",
            sa.String(),
            nullable=True,
            comment="Материал стояков ХВС",
        ),
        sa.Column(
            "cold_water_valve_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ запорной арматуры ХВС",
        ),
        sa.Column(
            "hot_water_riser_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ стояков ГВС",
        ),
        sa.Column(
            "hot_water_valve_wear",
            sa.Float(),
            nullable=True,
            comment="Физический износ запорной арматуры ГВС",
        ),
        sa.Column(
            "note", sa.Text(), nullable=True, comment="Дополнительное примечание"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False, comment="Дата создания"),
        sa.Column(
            "updated_at", sa.DateTime(), nullable=False, comment="Дата обновления"
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "CAPITAL_REPAIR_PROJECT",
                name="filecategoryenum",
            ),
            nullable=False,
