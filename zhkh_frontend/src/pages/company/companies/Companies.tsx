    ...
    return (
        <Container maxWidth="lg">
            <PageHeader
                ...
                body="Сервис содержит информацию о компаниях. Введите наименование компании в поисковую строку, чтобы
                получить подробные сведения об объекте: почту, адрес и
